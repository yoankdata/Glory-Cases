...
export default function ProPage() {
    const whatsappUrl = `https://wa.me/22500000000?text=${encodeURIComponent(
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="glass-card bg-white/5 border-white/10 p-8 text-center">
                            ...
                            <h3 className="font-display text-2xl text-white mb-4">Tarifs Volume</h3>
                            <p className="text-white/60">
                                Prix dégressifs à partir de 20 pièces.
                                Livraison internationale pour vos équipes dispersées.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-20 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-12 opacity-50">
                        {/* Logos placeholder */}
                        {['ENTREPRISE A', 'ENTREPRISE B', 'ENTREPRISE C', 'ENTREPRISE D'].map((name) => (
                            <div key={name} className="font-mono text-lg text-white/60 border border-white/20 px-6 py-3 rounded-lg">
                                {name}
                            </div>
                        ))}
                    </div>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="border border-white/20 rounded-3xl p-8 hover:border-gold/50 transition-colors">
                            <h3 className="font-mono text-sm uppercase tracking-wider text-gold mb-2">Essentielle</h3>
                            <p className="font-display text-4xl mb-4">À partir de 22 000 <span className="text-lg">FCFA/pièce</span></p>
                            <p className="text-white/60 mb-6">&nbsp;20 pièces minimum</p>

                            <ul className="space-y-3 text-white/80">
                                <li className="flex items-center gap-3">
                                    <span className="text-gold">✓</span> Étui standard au choix
                                </li>
                                <li className="flex items-center gap-3">
                                    <span className="text-gold">✓</span> Étiquette logo intérieure
                                </li>
                                <li className="flex items-center gap-3">
                                    <span className="text-gold">✓</span> Pochon coton sérigraphié
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="border-2 border-gold rounded-3xl p-8 relative overflow-hidden">
                            ...
                            <h3 className="font-mono text-sm uppercase tracking-wider text-gold mb-2">Premium</h3>
                            <p className="font-display text-4xl mb-4">Sur Devis</p>
                            <p className="text-white/60 mb-6">Personnalisation complète</p>

                            <ul className="space-y-3 text-white/80">
                                <li className="flex items-center gap-3">
                                    <span className="text-gold">✓</span> Design exclusif sur-mesure
                                </li>
                                <li className="flex items-center gap-3">
                                    <span className="text-gold">✓</span> Gravure logo extérieur
                                </li>
                                <li className="flex items-center gap-3">
                                ...
                                <li className="flex items-center gap-3">
                                    <span className="text-gold">✓</span> Livraison internationale
                                </li>
                            </ul>
                        </div>
                    </div>
