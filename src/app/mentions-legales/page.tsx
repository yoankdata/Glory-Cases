                    ...
                    <div className="space-y-12 font-light">
                        <section>
                            ...
                            <p className="leading-relaxed">
                                Le site <strong>www.glorycases.com</strong> est édité par la société <strong>GLORY GROUP</strong>.<br />
                                Siège social : Cocody, Abidjan, Côte d&apos;Ivoire.<br />
                                Email : <a href="mailto:contact@glorycases.com" className="hover:text-terracotta underline">contact@glorycases.com</a><br />
