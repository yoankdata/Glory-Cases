                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
                        ...
                        <div className="lg:sticky lg:top-28 lg:h-fit">
                            ...
                            {/* Zoom hint */}
                            <div className="mt-4 flex items-center justify-center gap-2 text-sm text-petrol/50 font-mono opacity-60">
                                <span className="text-lg">🔍</span> Survolez pour zoomer
                            </div>
                        </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="flex items-baseline gap-4">
                                ...
                                <span className="font-mono text-sm text-petrol/50 uppercase">
                                    Livraison offerte
                                </span>
                            </div>
                            ...
                            <div className="pt-4 space-y-4">
                                ...
                                <p className="text-center text-sm text-petrol/50">
                                    Paiement sécurisé • Livraison 48-72h sur Abidjan
                                </p>
                            </div>
                        </div>
                    </div>
