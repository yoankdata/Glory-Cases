...
Le summum du raffinement africain.`,
        ...
        images: ['/images/products/étui avec bijoux 2.jpg'],
        featured: true,
        new: false,
    },
    {
...
L'accessoire qui vous distingue du reste.`,
        ...
        colors: ['Marron', 'Or'],
        images: ['/images/products/étui gravure perso 2.jpg'],
        featured: true,
        new: false,
    },
...
Pour ceux qui privilégient l'élégance discrète.`,
        ...
        materialLabel: 'Simili Cuir',
        colors: ['Bleu Marine'],
        images: ['/images/products/etui-navy-classic.jpg'],
        featured: false,
        new: false,
    },
    {
...
L'accessoire parfait pour les beaux jours.`,
        ...
        materialLabel: 'Simili Cuir',
        colors: ['Bleu Azur'],
        images: ['/images/products/etui simple bleu.jpg'],
        featured: false,
        new: false,
    },
    {
...
L'élégance à l'état pur.`,
        ...
        materialLabel: 'Simili Cuir',
        colors: ['Bleu Nuit'],
        images: ['/images/products/étui simple bleu nuit.jpg'],
        featured: false,
        new: false,
    },
    {
...
Le choix évident pour ceux qui aiment l'essentiel.`,
        ...
        materialLabel: 'Simili Cuir',
        colors: ['Noir'],
        images: ['/images/products/étui simple noir.jpg'],
        featured: false,
        new: false,
    },
...
Pour les amateurs de pièces uniques et audacieuses.`,
        ...
        colors: ['Multicolore'],
        images: ['/images/products/etui-wax-abstrait.jpg'],
        featured: false,
        new: false,
    },
    {
...
L'accessoire qui met de bonne humeur.`,
        ...
        images: ['/images/products/etui-wax-coral.jpg'],
        featured: false,
        new: false,
    },
    {
...
Pour ceux qui aiment l'élégance discrète avec du caractère.`,
        ...
        images: ['/images/products/etui-wax-sombre.jpg'],
        featured: false,
        new: false,
    },
    {
...
L'Afrique authentique dans votre poche.`,
        ...
        colors: ['Multicolore'],
        images: ['/images/products/etui-wax-tribal.jpg'],
        featured: false,
        new: false,
    },
    {
...
Qualité et confort réunis.`,
        ...
        colors: ['Bleu Océan'],
        images: ['/images/products/etui simple bleu doublé.jpg'],
        featured: false,
        new: false,
    },
    {
...
L'esprit street dans votre poche.`,
        ...
        materialLabel: 'Denim',
        colors: ['Bleu Jean'],
        images: ['/images/products/étui en jean.jpg'],
        featured: false,
        new: false,
    },
    {
...
Pour ceux qui aiment les mélanges audacieux.`,
        ...
        colors: ['Multicolore'],
        images: ['/images/products/étui double tissu.jpg'],
        featured: false,
        new: false,
    },
    {
...
Pour les personnalités audacieuses et assumées.`,
        ...
        materialLabel: 'Wax Imprimé',
        colors: ['Rouge', 'Noir'],
        images: ['/images/products/étui motif rouge.jpg'],
        featured: false,
        new: false,
    },
    {
...
Portez un morceau de tradition africaine.`,
        ...
        images: ['/images/products/étui avec cory.jpg'],
        featured: false,
        new: false,
    },
    {
...
Un accessoire chargé de sens.`,
        ...
        materialLabel: 'Wax & Cauri',
        colors: ['Naturel', 'Brun'],
        images: ['/images/products/étui avce cory.jpg'],
        featured: false,
        new: false,
    },
    {
...
L'Afrique d'hier et d'aujourd'hui réunies.`,
        ...
        images: ['/images/products/étui form géo avec cory.jpg'],
        featured: false,
        new: false,
    },
    {
...
L'élégance à l'africaine.`,
        ...
        colors: ['Brun', 'Or'],
        images: ['/images/products/étui avec bijou 2.jpg'],
        featured: false,
        new: false,
    },
...
Faites de votre étui une pièce véritablement vôtre.`,
        ...
        materialLabel: 'Cuir Gravé',
        colors: ['Marron', 'Or'],
        images: ['/images/products/example étui avec marque gravé.jpg'],
        featured: false,
        new: false,
    },
    {
...
Un cadeau d'entreprise qui marque les esprits.`,
        ...
        materialLabel: 'Cuir Gravé',
        colors: ['Marron', 'Or'],
        images: ['/images/products/example étui avec marque gravé 2.jpg'],
        featured: false,
        new: false,
    },
    {
...
L'accessoire qui vous ressemble vraiment.`,
        ...
        materialLabel: 'Cuir Gravé',
        colors: ['Brun', 'Naturel'],
        images: ['/images/products/tui gravure perso.jpg'],
        featured: false,
        new: false,
    },
    {
...
Le summum de la personnalisation.`,
        ...
        images: ['/images/products/étui gravur perso 3.jpg'],
        featured: false,
        new: false,
    },
]
