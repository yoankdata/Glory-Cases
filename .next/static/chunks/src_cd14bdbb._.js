...
const WHATSAPP_URL = "https://wa.me/".concat(WHATSAPP_NUMBER);
function createWhatsAppUrl(message) {
    return "".concat(WHATSAPP_URL, "?text=").concat(encodeURIComponent(message));
}
const COMPANY = {
    name: 'Glory Cases',
    legalName: 'BLONE',
...
//# sourceMappingURL=src_cd14bdbb._.js.map